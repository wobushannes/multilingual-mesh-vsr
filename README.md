...
## 3. Phoneme Coverage Breakdown

- 730 distinct phonemes (automatically extracted)  
...
- Rare sounds included: uvular fricatives, pharyngeals, implosives, clicks (low frequency but present)

**Global benchmark**: PHOIBLE 2.0 = 3,183 segments over 2,186 languages → **~22.9% coverage**.  
This exceeds any single language (max ~140–161 in !Xóõ/Taa) by far.

## 4. Density Advantage

Mesh compresses brutally: 1 landmark ≈ 100 pixels effective info (often 150–300×).  
...
feel free to message me via GitHub Issues (or any other way you can reach me).  
Serious scientific/technical inquiries only – no spam/hype.

February 2026 – This is a new level.
